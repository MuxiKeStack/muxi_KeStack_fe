          ...
          {isRenderFooter && (
            <View className="mp-modal__footer">
              <View className="mp-modal__action">
                ...
                {confirmText && (
                  <Button onClick={this.onConfirm}>{confirmText}</Button>
                )}
              </View>
            </View>
          )}
