...
import image from '../../assets/png/stack.png';
            ...
            {showModal && (
              <View className="list">
                ...
                <View className="text">
                  ...
                  <View className="indent">我们如何使用收集的信息\n</View>
                  <View className="indent">
                  ...
                  <View className="indent">我们可能向您发送的信息\n</View>
                  <Text>
                    1、信息推送：您在使用我们的服务时，我们会向您发送通知信息。\n
                    2、与服务有关的公告：我们可能在必要时（例如，因系统维护而暂停某一项服务时）向您发出与服务有关的公告。\n
                  </Text>
                  <View className="indent">联系我们\n</View>
                  <Text>
                    如您对本条例或其他相关事宜有疑问，请通过QQ群：799651462与我们联系。\n
